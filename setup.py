...
#
#     from pyTrayStart import metadata
#
# However, when we do this, we also import `pyTrayStart/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'pyTrayStart_cli = pyTrayStart.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'pyTrayStart_gui = pyTrayStart.gui:entry_point'
        # ]
    }
)
